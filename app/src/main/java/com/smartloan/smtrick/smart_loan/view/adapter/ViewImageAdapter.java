...
import com.smartloan.smtrick.smart_loan.view.activite.ImageSwipZoomActivity;
...
public class ViewImageAdapter extends RecyclerView.Adapter<ImageViewHolder> {
        ...
        try {
            ...
            holder.iv_businessimage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startImageSwipeZoomActivity(holder.getAdapterPosition());
                }
            });
     ...
     */
    private void startImageSwipeZoomActivity(int pos) {
        try {

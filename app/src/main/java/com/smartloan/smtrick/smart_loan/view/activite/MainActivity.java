...
public class MainActivity extends AppCompatActivity
    ...
    private ImageUploadReceiver imageUploadReceiver;
    private SearchView searchView;
    private MenuItem searchMenuItem;
    private LeedsFragment leedsFragement;
    ...
    protected void onResume() {
        super.onResume();
        if (selectedFragement.equals(leedsFragement)
    ...
    public void updateNavigationHeader() {
        try {
            ...
            TextView textViewAddress = header.findViewById(R.id.text_view_address);
            ...
            if(!Utility.isEmptyOrNull(appSharedPreference.getAddress()))
            textViewAddress.setText(appSharedPreference.getAddress());
